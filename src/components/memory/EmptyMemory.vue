...
<template>
  <p data-testid="memory-zero-state" class="rounded-card bg-surface-card px-5 py-4 text-center font-lesson text-[15px] leading-[1.8] text-ink-muted">
    {{ MEMORY_ZERO_STATE_COPY }}
  </p>
</template>
