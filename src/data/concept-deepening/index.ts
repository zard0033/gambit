    ...
    steps: [
      {
        ...
        successText: '將軍捉雙（皇家捉雙）：對手忙著救王，你下一步就吃后。將軍的捉雙最致命——對手沒有選擇。',
      },
      {
  ...
  discovered: {
    ...
    steps: [
      ...
      },
      {
        ...
        expectedMove: { from: 'e4', to: 'c6' },
        hint: '主教跳到 c6：它從 c6 將軍王（c6-d7-e8），又讓開 e 線露出城堡＝雙將，而且 c6 正盯著 a8 的后。',
        successText: '雙將最霸道：兩個子同時將軍，王只能移動、不能擋也不能吃。下一步從容吃掉 a8 的后。',
      },
      {
  ...
  defense: {
    ...
    steps: [
      ...
      },
      {
        ...
        hint: '幫騎士找後盾。主教走哪步能保護 d3？這樣對手吃騎士，你就用主教吃回更值錢的城堡。',
        successText: '加一個防守者：對手若吃騎士，你用主教換到更值錢的城堡——他反而虧。子不必逃，威脅也化解。',
      },
      {
