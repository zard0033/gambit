...
export const epiphanyTemplates: JournalTemplate[] = [
  {
    id: 'epiphany.1',
    pen: 'epiphany',
    render: (p) => `這一手「${p['概念']}」，我一句都沒提醒——是你自己看見的。這雙眼睛，從現在起是你的了。`,
  },
  {
    id: 'epiphany.2',
    pen: 'epiphany',
    render: (p) => `我退到了一旁，盤面什麼也沒指。可你還是找到了那步「${p['概念']}」。看出來，比被教會更難——你做到了。`,
  },
  {
    id: 'epiphany.3',
    pen: 'epiphany',
    render: (p) => `沒有提示、沒有箭頭，你獨自認出了「${p['概念']}」。我教的東西，今天起住進了你眼裡。`,
  },
  {
    id: 'epiphany.4',
    pen: 'epiphany',
  ...
  },
  {
    id: 'epiphany.5',
    pen: 'epiphany',
    render: (p) => `從前要我指給你看的「${p['概念']}」，這次你自己就認出來了。我很安靜，可我都看在眼裡。`,
  },
  {
    id: 'epiphany.6',
    pen: 'epiphany',
    render: (p) => `我什麼都沒說，你卻把「${p['概念']}」看穿了。往後坐上棋盤，這雙眼睛會一直陪著你。`,
  },
]
