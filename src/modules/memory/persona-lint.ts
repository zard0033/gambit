 ...
 *
 * Reuses the house emoji + xiangqi-piece-term check (`@/lib/persona-lint`'s `lintBody`) and adds
 * 棋憶's banned tokens. CJK-not-italic is a render-time CSS concern asserted in the view layer, not here.
 */
