...
describe('route-table', () => {
  ...
  it('test_routeTable_containsExactlyExpectedRoutes', () => {
    ...
    expect(paths).toEqual(['/', '/play', '/learn', '/learn/concepts', '/learn/concept/:conceptId', '/learn/:lessonId', '/dungeon', '/dungeon/:puzzleId', '/review', '/history', '/journal', '/replay/:gameId', '/profile', '/sign-in', '/:pathMatch(.*)*'])
  })
