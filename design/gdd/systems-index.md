...
| 19 | Dungeon Puzzle Mode | Gameplay | Phase 2 | **Partially superseded 2026-08-05**（D2：關卡地圖／掛鎖／進度刪除，解題本體活在 `/practice/:puzzleId`） | [dungeon-puzzle-mode.md](./dungeon-puzzle-mode.md) ([review log](./reviews/dungeon-puzzle-mode-review-log.md)) | Chess Board, Navigation & Routing, Lesson System (pattern) |
...
| 21 | ~~Journal (棋誌)~~ | — | — | **Removed 2026-08-05**（定位 v2 的 D1；GDD 與 review log 一併刪除，決策紀錄留在 ADR-0013 Superseded） | — | — |
...
| Metric | Count |
|--------|-------|
| Total systems identified | 21（#21 Journal 已於 2026-08-05 移除，編號保留不回收；#19 部分 superseded） |
